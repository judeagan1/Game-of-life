    ...
    */
    ...
    for (auto ith_iteration = 0; ith_iteration < numIterations; ith_iteration++) {
        ...
        */
        ...
        // add in a check here to see if the board did not change / completely died out and terminate if it did
        // before finishing, we set our world equal to our newly created world 
